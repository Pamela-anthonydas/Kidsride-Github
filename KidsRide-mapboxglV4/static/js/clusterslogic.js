  ...
  for (var i = 0; i < response.length; i++) {
    ...
    if(cat==="Dance Classes"){
      ...
      if (location) {
          ...
          danceMarkers.push(
            L.marker((response[i].location),{icon: danceIcon}).bindPopup("<h1>" + response[i].name + "</h1>"+"<h4>" + response[i].address+"<h4>")
    ...
    // For record of type "Music Classes" , create location markers
       ...
       // Check for location property
        if (location) {
          ...
          musicMarkers.push(
          L.marker((response[i].location),{icon: musicIcon}).bindPopup("<h1>" + response[i].name + "</h1>"+"<br>"+"<h4>" + response[i].address+"<h4>")
    ...
    // For record of type "Sports Classes" , create location markers
        ...
        if (location) {
          ...
          sportsMarkers.push(
            L.marker((response[i].location),{icon: sportsIcon}).bindPopup("<h1>" + response[i].name + "</h1>"+"<h4>" + response[i].address+"<h4>")
